...
function topicModal(topic) { return `<div id="topicModal" class="fixed inset-0 z-50 hidden overflow-y-auto"><div id="modal-backdrop" class="modal-backdrop fixed inset-0"></div><div class="min-h-full flex items-start justify-center px-4 py-6"><section class="modal-card w-full max-w-5xl mb-10 p-5 md:p-8"><button id="modal-close" aria-label="Cerrar modal" class="absolute right-4 top-4 h-10 w-10 rounded-full bg-white/10 text-white">×</button><p class="text-xs uppercase tracking-[.18em] text-cyan-100">${topic.unit}</p><h2 class="text-3xl font-black text-white mt-2">${topic.title}</h2><p class="section-subtitle mt-2">${topic.desc}</p><div class="grid md:grid-cols-2 gap-4 mt-6"><button id="modal-slides" class="bento-action p-5 text-left"><h3 class="font-black text-white">Slides y teoría</h3></button><button id="modal-game" class="bento-action p-5 text-left"><h3 class="font-black text-white">Gamificación</h3></button><button id="modal-homework" class="bento-action p-5 text-left"><h3 class="font-black text-white">Deber interactivo</h3></button><button id="modal-results" class="bento-action p-5 text-left"><h3 class="font-black text-white">Resultados</h3></button></div></section></div></div>`; }
